...
public class Main2 {
  public static void main(String[] args) {
    ...
    String day = "";
    String[] calendar = {{"","January","February","March","April","May","June","July","August","September","October","November","December"}}; //Start at string[1] for months
    ...
    day = cin.next();
    while (!day.toLowerCase().matches("(sunday|monday|tuesday|wednesday|thursday|friday|saturday)")) { //Determine if valid input
    ...
    for (int i=1; i<=calendar.length-1; i++) { //Loop per month
      ...
      for (int j=1; j<startWeek; j++) //Insert empty spaces in first week
        System.out.printf("%s", "   ");
